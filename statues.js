...
statues = [
  ...
  //Deep Woods
  {x: 2350, y: 1543, z:10250, map:             "Deep Woods", name:                "Island"},
  ...
  {x:    0, y: 1100, z: -1100,map:         "Fire Sanctuary", name:"Initial Outdoor Bridge"},
  ...
  //Lanayru Desert
  {x: 1680, y: 1984, z:18933, map:         "Lanayru Desert", name:"       Desert Entrance"},
  {x:-2117, y:  475, z:-6749, map:         "Lanayru Desert", name:"          North Desert"},
  {x:-23334,y:   50, z:  749, map:         "Lanayru Desert", name:"          Desert Gorge"},
  {x:-34352,y:   50, z:-4031, map:         "Lanayru Desert", name:"        Temple of Time"},
  {x:-14960,y:   80, z: 8300, map:         "Lanayru Desert", name:"           West Desert"},
  {x: 9300, y:  226, z:10200, map:         "Lanayru Desert", name:"           Stone Cache"},
  //Ancient Harbor
  {x:10175, y: 2293, z:35566, map:           "Lanayru Mine", name:"              Entrance"},
  //Sand Sea Docks
  ...
  //Sealed Grounds
  {x:-11029,y: 7500, z: 6279, map:         "Sealed Grounds", name:"     Behind the Temple"},
  {x: 1365, y: 7600, z:10420, map:         "Sealed Grounds", name:"         Sealed Temple"},
  {x:-8043, y: 8403, z:  153, map:         "Sealed Grounds", name:"                Spiral"},
  //Past Sealed Grounds
